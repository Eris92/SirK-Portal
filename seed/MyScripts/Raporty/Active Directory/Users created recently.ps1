#PL Ostatnio utworzeni użytkownicy AD | Zwraca użytkowników AD utworzonych w wybranym okresie.
#EN Recently created AD users | Returns AD users created within the selected period.
# Approval: false
