...
assert.ok(css.indexOf(".sirk-portal-view-host > .sirk-platform-management-host") >= 0, "Management must be normalized inside the shared host.");
assert.ok(css.indexOf(".sirk-portal-view-host > .sirk-platform-management-host > .sirk-management-shell") >= 0, "Management shell must not draw a second outer frame.");
