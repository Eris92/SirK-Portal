(function () {
    ...
    function createResultsButton(host, active, onClick) {
        ...
        button.type = "button";
        button.className = "sirk-nav-item sirk-nav-item sirk-nav-item mc-catalog-results sirk-result-status sirk-result-status-all";
        button.title = "Results";
        button.setAttribute("aria-label", "Results");

        var icon = document.createElement("span");
        icon.className = "mc-tree-fallback-icon sirk-nav-icon sirk-result-status-icon sirk-nav-icon";
